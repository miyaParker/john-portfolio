        ...
        <div className='w-full px-[20px] md:px-[40px] lg:px-[80px] xl:px-[200px]'>
          <div className='mb-[80px]'>
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px]  text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              There has been a recent rise in deaths due to the absence of quick
              blood donors and the bureaucracy associated with sick people
              quickly getting their required blood type. According to the WHO,
              out of the 75 countries that report fewer than 10 donations per
              1000 people, 38 are from Africa.
            </p>
          </div>
          <motion.div
          ...
          >
            ...
            <p className='w-full font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              To ensure the sustainability of lives and blood banks in Nigeria,
              we thought it important to design a mobile application that allows
              people desperately in need of blood to get quick access to blood
              in their neighborhood and locality without distance being a
              challenge to them getting good health care.
            </p>
            <p className='w-full font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              It also provides an opportunity for donors to donate blood freely
              at their convenience and at the nearest preferred blood donation
              center close to them without necessarily visiting a hospital.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='w-full font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              LifeSource is a blood donation app that connects potential donors
              to patients in need of blood. It makes reaching out to potential
              donors simple and helps people to become voluntary donors. In
              addition, donors can track the impact of their donations and
              create awareness around blood donation.
            </p>
            <p className='w-full font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              ...
              male’s volume is between 5 and 6 liters, and the average female's
              is between 4 and 5 liters.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
            ...
            <p className='w-full font-calibre font-thin leading-[150%] mt-[80px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              Underscoring the need for blood donations is the fact that Nigeria
              has the fourth-highest maternal mortality rate in the world,
              accounting for 19% of all maternal deaths globally, with
              postpartum hemorrhage (the loss of too much blood following birth)
              leading the cause of such deaths, and the lack of infrastructure
              to get crucial blood supplies in Nigeria compounds this problem.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
            ...
            <p className='w-full font-calibre font-thin leading-[150%] mt-[80px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
              ...
              people perceive it based on their religious beliefs. For instance,
              Jehovah's Witness believers see blood donation and transfusion as
          ...
          <div className='mt-[128px]'>
            ...
            <motion.p
              ...
              className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
            >
              This research aims to validate the claim of a lack of blood donors
              and the problems associated with blood donations. Furthermore,
              this research enlightens us on the steps and decisions to design a
              better solution to the problem. Design decisions were made
              regarding user flow, user pain points, and user goals based on the
              research results.
            </motion.p>
            <motion.p
              initial={{opacity: 0, y: 100}}
              ...
              className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
            >
              After performing user interviews with 18 people, we discovered the
              key problem areas. This can be seen HERE
            </motion.p>
          </div>
          <div className='mt-[128px]'>
            <motion.h2
            ...
            <div className='ml-8'>
              <motion.p
                ...
                className='flex gap-x-4 items-center font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
              >
                i) The process of blood donation is cumbersome and tiring for a
                lot of people
              </motion.p>
              <motion.p
                initial={{opacity: 0, y: 100}}
              ...
              <motion.p
                ...
                className='flex gap-x-4 items-center font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
              >
                iii) Lack of proper awareness to donors on the benefits attached
                to blood donation to citizens
              </motion.p>
              <motion.p
                initial={{opacity: 0, y: 100}}
                whileInView={{opacity: 1, y: 0}}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              pinpointing the pain points, frustrations, needs, and emotions of
              donors, I came up with a potential solution that addresses the
              discovered problems, putting the patients and donors in mind.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              Users will be given two choices: login or sign up. Users are also
              asked to complete their accounts using a one-time password sent to
              their email box.
            </p>
            <img
              src={Screen5}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              home page, thus creating pleasing and actionable experiences that
              keep the users engaged with the app.
            </p>
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              Based on research, I introduced a bottom navigation, so users have
              access to important features instantly.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              After a series of questions have been asked of the donor, a screen
              is shown to tell whether the screening stage was successful or
              not. From there, the donor would be prompted to either go back to
              the homepage or proceed to donate blood. This reduces the process
              of blood donation from being cumbersome and tiring for a lot of
              people, which was one of the problems highlighted during the
              research and empathizing stages.
            </p>
            <img
              src={Screen8}
              width={567}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              In the donor section, users can enter the blood type and location
              they are looking for and proceed to send messages. After obtaining
              a list of donors available through donor search, donor search can
              send donor requests to available donors.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              Users can turn on and off their donor status on the profile page,
              check rewards won, points earned, badges, total donations, and
              active donations and rewards.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              date, and time. He can also reschedule based on his availability.
            </p>
            <motion.img
              initial={{opacity: 0, y: '10vh'}}
              whileInView={{opacity: 1, y: 0}}
          ...
          <div className='mt-[128px]'>
            ...
            <motion.p
              ...
              className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
            >
              Designing the app has been a challenging and rewarding journey. It
              was clear from the onset that the major challenge would be to
              design a mobile application that allows people desperately in need
              of blood to get quick access to blood in their neighborhood and
              locality without distance being a challenge to them getting good
              health care.
            </motion.p>
            <motion.p
              initial={{opacity: 0, y: 100}}
            ...
            >
              ...
              creating an engaging app both from the user experience perspective
              and the visual perspective.
            </motion.p>
          </div>
          <div className='mt-[128px]'>
            <motion.h2
