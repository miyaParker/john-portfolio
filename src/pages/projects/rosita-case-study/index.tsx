        ...
        >
          <div className='mb-[80px]'>
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px]  text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              follow along on my journey to use technology to place food orders
              from the a restaurant request home delivery while battling
              COVID-19.
            </p>
          </div>
          <motion.div
          ...
          >
            ...
            <div className='pt-[28px] lg:pt-[36px] flex flex-col lg:flex-row gap-[18px] justify-between'>
              ...
              <div className='max-w-[593px] flex-1'>
                ...
                <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
                  Lead the prototyping, conducted design sprints, led usability
                  testing, designed low-fi and mid-fi applications, led high
                  fidelity design and visual direction.
                </p>
              </div>
            </div>
          ...
          <div className='mt-[128px] flex flex-col lg:flex-row gap-[18px] justify-between lg:items-center'>
            <div>
              ...
              <p className='max-w-[530px] font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
                The actual focus of this project was to design a reservation app
                for Rosita African Cuisine’s customers to order their meals and
                food promptly and get delivered as fast as possible.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className='max-w-[603px] font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
                ...
                design for. I first narrowed my user group to Nigerians between
                the ages of 16 - 64, as this age range has the highest internet
            ...
            <div>
              ...
              <p className='max-w-[603px] font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
                ...
                convenient and efficient ordering experience while expanding the
                delivery reach and reducing operational costs for the
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              from existing resources, reports and documents available in public
              libraries and websites on the state of food delivery in the
              country.
            </p>
            <img
              src={Research}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              well-rounded foundation of knowledge about the market our product
              will enter.
            </p>
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              individual sections are related to each other. They also help you
              understand how users navigate through the mobile app.
            </p>
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              not-to-learned individuals so they could follow through. The users
              are prompted to choose their preferred sign-up account type before
              signing up. The sign-up process includes SSO (Single Identity
              Sign-On), thus prioritizing popular sign-up methods like Google
              and Apple.
            </p>
            <img
              src={Registration}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              Usability testing of the high-fidelity prototype was conducted to
              see how users interact with the product. I designed a test plan
              and conducted usability testing to validate the concept.
          ...
          >
            ...
            >
              ...
              <p className='mt-4 max-w-[750px] font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                I loved working on this project as I learned how to manage time,
                make decisions based on our limited resources, and hack through
                all blockers.
              </p>
