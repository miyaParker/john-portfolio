        ...
        <div className='w-full px-[20px] md:px-[40px] lg:px-[80px] xl:px-[200px]'>
          <div className='mb-[80px]'>
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px]  text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              The Human Resources field has experienced several changes over the
              years. Changes have led to the automation of specific tasks and
              processes. Some of those improvements have made it easier to
              monitor the records of employees, reduce paper waste, retrieve
              employee data, and effectively manage onsite and remote employees.
              However, most HR Management software lacks some core HR functions,
          ...
          >
            ...
            <div className='ml-8'>
              ...
              <p className='font-calibre mb-8 font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                Although this is a dedicated tool, the capability can show up as
                part of a larger HRMS — Human Resource Management Software or
                those that focus on businesses where this capability is
                essential.
              </p>
              <p className='font-calibre mb-8 font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                <span className='font-medium text-white'>
                ...
                The ability to record employee goals or track goals down to the
                task level and tie success directly and automatically to
              ...
              <p className='font-calibre mb-8 font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                <span className='font-medium text-white'>6. Integration: </span>{' '}
                Implementing with an existing legacy system (e.g., Office 365,
                Slack, etc.)
              </p>
              <p className='font-calibre mb-8 font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                <span className='font-medium text-white'>7. Scalability: </span>{' '}
                Mobility, and security (protection of customers financial and
                personal data)
              </p>
              <p className='font-calibre mb-8 font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                8. <span className='font-medium text-white'>Others: </span> Set
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              provides insight into the company’s spending on employee benefits.
            </p>
            <img
              src={Screen3}
              width={567}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              The payroll section gives general information about employees’ pay
              and keeps track of their earnings. This feature eliminates the
              miscalculation of data and affords a system for managing payroll
              details automatically. With CheckBox, HR managers can easily
              generate salary statements, control payday, and ensure accuracy.
            </p>
            <img
              src={Screen4}
              width={567}
          ...
          >
            ...
            <p className='w-full font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              Keeps track of employee productivity. With this, an HR manager can
              assign KPIs and monitor employees’ performance, ensuring prompt
              and active feedback. The overtime feature ensures employees are
              properly compensated for their work time without missing any
              detail. The attendance management system is equipped to track
              employee attendance and leave, thus helping both parties process
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              ...
              company’s activities. The report generated helps the company make
              decisions on hiring costs, turnover rate, performance, etc.
            </p>
            <img
              src={Screen7}
              width={567}
          ...
          >
            ...
            <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
              View Notifications in real-time and stay abreast of the activities
              of employees. Get updates on new leave requests, payroll creation,
              attendance management, new clients, project deadlines, etc.
            </p>
            <img
              src={Screen11}
              width={567}
