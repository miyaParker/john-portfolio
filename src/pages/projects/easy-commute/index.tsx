          ...
          <div className='w-full px-[20px] md:px-[40px] lg:px-[80px] xl:px-[200px]'>
            <div className='mb-[80px]'>
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px]  text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                interviews and usability testing, Easy Commute allows the
                booking of tickets to be easy and uncomplicated, as well as
                making it easy for users to see and track their journeys and
                train times.
              </p>
            </div>
            <motion.div
              ...
              <div className='pt-[28px] lg:pt-[36px] flex flex-col lg:flex-row gap-[18px] justify-between'>
                <div className='max-w-[586px] flex-1'>
                  ...
                  <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] leading-[138%] md:text-[24px] lg:text-[28px]'>
                    Easy Commute is a digital rail technology platform that
                    offers train tickets and rail cards for sale. It provides a
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                These were the final results of what we decided as the metrics
                and KPIs for the Easy Commute Mobile App.
              </p>
              <img
                src={Outcome}
                width={567}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                and how competitors and users behave. I researched several
                forums and top websites with personal rapport with users and
                detailed their pain points. Getting this information early in
                the process was essential before having an idea or prototyping.
              </p>
              <img
                src={Research}
                width={567}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                discussions and gain relevant insights. The goal for the
                interview was to indiscriminately gather personal opinions on
                each individual's experience with train booking and gather their
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                For Easy Commute Mobile app, I ranked and organized features
                based on customer value, business goals, the amount of time and
            ...
            >
              ...
              >
                ...
                interested in traveling to order and buy tickets from the
                comfort of their homes. The users can search for daily train
                movements based on timings and locations, verify their ID cards
                within minutes of upload, top up their rail cards, and pay for
                tickets with their debit card, PayPal, or their Apple or Google
                Pay wallet within seconds.
              </motion.p>
            </motion.div>
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                project, I had the constraint of exploring only one task flow,
                and the MVP will allow people to book a train.
              </p>
              <motion.img
                initial={{opacity: 0, y: 100}}
                whileInView={{opacity: 1, y: 0}}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                sections, and pages from scratch to ensure visual consistency
                and facilitate quick design changes.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                initial thoughts of the necessary screens needed for Easy
                Commute
              </p>
              <img
                src={Sketch1}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                application. The goal here is to demonstrate some facts about
                the application, such as how to use it, its features, and how it
                can help the users.
              </p>
              <img
                src={Screen4}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                and an option to choose a payment method for the ticket
                purchase.
              </p>
              <img
                src={Screen5}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                all, I factored in different methods of payment so that
                everyone, irrespective of their persona, would be able to pay
                for their train ticket at not more than 2-3 clicks of a button.
                This has accommodated the cash-only means of payment problem
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                was that users were streamlined to just a limited number of
                types of ID cards to verify their details. As a solution, I
                added a feature to the product that allows everyone to verify
                their documents with different ID cards.
              </p>
              <motion.img
                initial={{opacity: 0, y: 100}}
                whileInView={{opacity: 1, y: 0}}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                For this project, I created a document that addresses logo
                usage, font usage, and color usage to ensure complete uniformity
                in style and formatting wherever the brand is used.
              </p>
              <img
                src={StyleGuide}
                width={567}
              ...
              >
                ...
                >
                  1. <span className='font-bold text-white'>Trust: </span> Blue
                  is often associated with trust, dependability, and
                  reliability. As such, using blue as the primary color for a
                  train booking app can help establish a sense of trust between
                ...
                <motion.p
                  ...
                  className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'
                >
                  2. <span className='font-bold text-white'>Calmness: </span>{' '}
                  Blue is also often associated with calmness, serenity, and
                  relaxation. As booking a train can be a stressful experience
                  for some users, using blue as the primary color can help
                  create a calming effect and reduce anxiety.
                </motion.p>
                <motion.p
                  initial={{opacity: 0, y: 100}}
                  whileInView={{opacity: 1, y: 0}}
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                ...
                should be iterated by considering usability tests, A/B tests,
                and other in-depth surveys with the user to improve the initial
                version. That said, launching this functionality is only the
                first step toward the product’s success.
              </p>
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
            ...
            >
              ...
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                This project was exciting and interesting. It allowed me to
                learn a new prototyping tool, Protopie, become more versed in
                using interactive components, and involve tons of desk and
                market research.
              </p>
              <p className='font-calibre font-thin leading-[150%] mt-[13px] text-gray text-[22px] md:text-[24px] lg:text-[28px]'>
                The next step will be to conduct more robust user testing on the
                prototype I currently have to improve the user flow. I would
                also love to explore more User Epics for the application, such
                as precise booking dates and times, phone notifications for
                discount prices, and opportunities for ticket refunds.
              </p>
            </motion.div>
            <Contact />
          </div>
